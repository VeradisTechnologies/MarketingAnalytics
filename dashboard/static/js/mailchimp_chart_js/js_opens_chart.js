                    ...
                    if (index == i) {
                        if (is_chart_selected) {
                            unique_opens_val[i] = {
                                ...
                                itemStyle: { normal: { color: getOrigColor('hsl(217, 37%, 78%)') } }
                            }
                            total_opens_val[i] = {
                                value: total_opens_val[i],
                                itemStyle: { normal: { color: getOrigColor('hsl(217, 44%, 59%)') } }
                            }
                            campaigns_val[i] = {
                                value: campaigns_val[i],
                                itemStyle: { normal: { color: getOrigColor('hsl(45, 66%, 56%)') } }
                            }
                            mail_send_val[i] = {
                                value: mail_send_val[i],
                                itemStyle: { normal: { color: getOrigColor('hsl(45, 80%, 75%)') } }
                            }
                        }
                        else {
                            if (unique_opens_val[i].value) {
                                unique_opens_val[i] = {
                                    value: unique_opens_val[i],
                                    itemStyle: { normal: { color: '#c5cbd4' } }
                                }
                            }
                            if (total_opens_val[i].value) {
                                total_opens_val[i] = {
                                    value: total_opens_val[i],
                                    itemStyle: { normal: { color: '#96a9c7' } }
                                }
                            }
                            if (campaigns_val[i].value) {
                                campaigns_val[i] = {
                                    value: campaigns_val[i],
                                    itemStyle: { normal: { color: '#ddc26e' } }
                                }
                            }
                            if (mail_send_val[i].value) {
                                mail_send_val[i] = {
                                    value: mail_send_val[i],
                                    itemStyle: { normal: { color: '#f4e2ad' } }
                                }
                            }
                            chart_state = true
                            index = -1
                        ...
                        unique_opens_val[i] = {
                            value: unique_opens_val[i],
                            itemStyle: { normal: { color: getHighLightColor('#c5cbd4') } }
                        }
                        total_opens_val[i] = {
                            value: total_opens_val[i],
                            itemStyle: { normal: { color: getHighLightColor('#96a9c7') } }
                        }
                        campaigns_val[i] = {
                            value: campaigns_val[i],
                            itemStyle: { normal: { color: getHighLightColor('#ddc26e') } }
                        }
                        mail_send_val[i] = {
                            value: mail_send_val[i],
                            itemStyle: { normal: { color: getHighLightColor('#f4e2ad') } }
                        }
                    }
