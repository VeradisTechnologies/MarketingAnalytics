function city_chart(chart_data,drillDown_params=null) {
    ...
    try {
        ...
        chart_color=['#FF6633', '#c6cad3', '#FF33FF', '#FFFF99', '#00B3E6','#E6B333', '#3366E6', '#999966', '#96a9c7', '#B34D4D','#80B300', '#809900', '#E6B3B3', '#6680B3',  '#f4e3ad', '#CCFF1A', '#b4d2ba', '#ddc36f', '#33FFCC','#66994D', '#B366CC', '#4D8000', '#B33300', '#CC80CC',  '#66664D', '#991AFF', '#E666FF', '#4DB3FF', '#1AB399', '#E666B3', '#33991A', '#CC9999', '#B3B31A', '#00E680','#4D8066', '#809980', '#E6FF80', '#1AFF33', '#999933','#FF3380', '#CCCC00', '#66E64D', '#4D80CC', '#9900B3','#E64D66', '#4DB380', '#FF4D4D', '#99E6E6','#66991A', '#6666FF'];
        var top_4_colors = ['#96a9c7', '#f4e2ad', '#c5cbd4', '#ddc26e']

        var top_4_values = chart_data['city_data'].sort((a, b) => parseFloat(a.value) - parseFloat(b.value)).slice(chart_data['city_data'].length - 4, chart_data['city_data'].length)
        color_inx = 0
        chart_data['city_data'].forEach(function(value, index){
            top_4_values.forEach(function(value2, index2){
                if(value['name'] === value2['name']){
                    chart_data['city_data'][index].itemStyle = {color: top_4_colors[color_inx]}
                    color_inx += 1
                }
            })
        });
