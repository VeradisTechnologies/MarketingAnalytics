...
function ajax_ga_summary_top_chart(period){
    selected_month = $("#month_value").val()
    selected_year =  $("#year_value").val()
    ...
    $.ajax({
        ...
        success: function (data) {            
            if (data['data'] == true) {
                $("#ga_visits").text(Number( data['visits'] ).toLocaleString('en-us'))
                $("#ga_bounce_rate").text(Number( data['bounce_rate']).toLocaleString('en-us'))
                $("#ga_avg_page_views").text(Number( data['avg_page_views'] ).toLocaleString('en-us'))
                $("#ga_avg_duration").text(Number( data['avg_duration'] ).toLocaleString('en-us'))
                $("#ga_new_users").text(Number( data['new_users'] ).toLocaleString('en-us'))
            } else {
                $("#ga_visits").text('NA')
