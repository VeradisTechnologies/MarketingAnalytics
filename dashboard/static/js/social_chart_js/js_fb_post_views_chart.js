        ...
        fb_post_views_option = {
            ...
            tooltip: {
                ...
                formatter: function (param) {
                    var unique_impressions_tooltip = '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#96a9c7;"></span>';
                    ...
                    var paid_impressions_tooltip = '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#2a456c;"></span>';
