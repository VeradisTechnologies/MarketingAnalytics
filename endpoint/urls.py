...
from .views import (gender_data,conversion_chart_data,interacton_chart_data,visitors_data,
                device_data,city_chart_data,total_page_data,pageview_data,ga_summary_top_chart,agegroup_data,engagement_chart_data,
                ...
                insta_total_likes_followers,gender_data_social,fb_total_summary, session_check, opens_chart_data, click_through_chart_data,
...
urlpatterns = [
    ...
    path("endpoint/fb_total_summary",fb_total_summary),
