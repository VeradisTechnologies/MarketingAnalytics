function top_pages_chart(chart_data) {
    ...
    try {
        var top_pages = document.getElementById("top_pages_chart_container_sml");
            ...
            series: [
                {
                    ...
                    type: 'bar',
                    barWidth: 25,
                    data: [{value: axis_value[0],itemStyle: {color: '#ddc36f'}}, {value: axis_value[1],itemStyle: {color: '#f4e3ad'}}, 
