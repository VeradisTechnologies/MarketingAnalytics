            ...
            series: [
                {
                    ...
                    type: 'bar',
                    barWidth: 25,
                    data: [{value: chart_data['page_count'][0],itemStyle: {color: '#ddc36f'}}, {value: chart_data['page_count'][1],itemStyle: {color: '#f4e3ad'}}, 
                        {value: chart_data['page_count'],itemStyle: {color: '#96a9c7'}}, {value: chart_data['page_count'][3],itemStyle: {color: '#c6cad3'}}, 
                        {value: chart_data['page_count'],itemStyle: {color: '#b4d2ba'}}
                    ],
                },
            ]
        };
