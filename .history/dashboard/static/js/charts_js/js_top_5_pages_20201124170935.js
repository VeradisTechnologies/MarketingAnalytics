function top_pages_chart(chart_data) {
    ...
    try {
        ...
        // for(i=0;i<axis_value.length;i++){
        //     var top5_axis_label = axis_label[i];
        //     var top5_axis_value = axis_value[i];
        // }
        ...
        top_page_option = {
            ...
            yAxis: {
                type: 'category',
                data: [
                    {value: axis_label[0],itemStyle: {color: '#ddc36f'}}, {value: axis_value[1],itemStyle: {color: '#f4e3ad'}}, 
                    {value: axis_value[2],itemStyle: {color: '#96a9c7'}}, {value: axis_value[3],itemStyle: {color: '#c6cad3'}}, 
                    {value: axis_value[4],itemStyle: {color: '#b4d2ba'}}
                ],
                nameTextStyle: {
                    fontSize: 9,
                    padding: 0,
            ...
            series: [
                {
                    ...
                    barWidth: 25,
                    data: [
                        {value: axis_value[0],itemStyle: {color: '#ddc36f'}}, {value: axis_value[1],itemStyle: {color: '#f4e3ad'}}, 
                        {value: axis_value[2],itemStyle: {color: '#96a9c7'}}, {value: axis_value[3],itemStyle: {color: '#c6cad3'}}, 
                        {value: axis_value[4],itemStyle: {color: '#b4d2ba'}}
                    ],
                },
