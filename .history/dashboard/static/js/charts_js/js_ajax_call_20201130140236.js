    ...
    $.ajax({
        ...
        success: function (data) {            
            if (data['data'] == true) {
                ...
                $("#ga_visits").text(Number( data['ga_visits'] ).toLocaleString('en-us'))
                $("#ga_bounce_rate").text(Number( data['ga_bounce_rate'] ).toLocaleString('en-us'))
                $("#ga_avg_page_views").text(Number( data['ga_avg_page_views'] ).toLocaleString('en-us'))
                $("#ga_avg_duration").text(Number( data['ga_avg_duration'] ).toLocaleString('en-us'))
                $("#ga_new_users").text(Number( data['ga_new_users'] ).toLocaleString('en-us'))
