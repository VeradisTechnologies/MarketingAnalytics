function likes_chart(chart_data) {
    ...
    /*if (full_size_chart == 'like_chart_container') {
        grid_size = [30, 55, 30, 70]
    ...
    try {
        ...
        like_chart_option = {
            // color: ['#4FDAD5','#498CE7', '#8AB4F0', '#F28801'], 
            //'#96a9c7', '#ddc26e', '#56aea2', '#5ebfb2', '#f4e2ad' #
            ...
            },
            {
                ...
                type: 'bar',
                barWidth: bar_size,
                data: chart_data['twitter_likes_data']
            },
