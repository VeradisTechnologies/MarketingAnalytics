                ...
                formatter: function (param) {
                    ...
                    if (param.length >= 1) {
                        ...
                        for (i = 0; i < param.length; i++) {
                            ...
                            var total_twitter_followers_comma_value = numberWithCommas(Number(chart_data['total_twitter_followers_tooltip'][param[i]['dataIndex']]))
                            var new__twitter_fans_followers_comma_value = numberWithCommas(Number(chart_data['new_twitter_fans'][param[i]['dataIndex']]))
